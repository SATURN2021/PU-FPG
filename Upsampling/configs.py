...
# model
parser.add_argument('--model', default='pugcn', help='model name: punet, pugan, mpu, pugcn, pufpg')
...
parser.add_argument('--k0', type=int, default=20, help="number of neighbors used in LCD")
parser.add_argument('--k1', type=int, default=10, help="number of neighbors used when calculate normals")
parser.add_argument('--k2', type=int, default=20, help="number of neighbors used in LND")
parser.add_argument('--k3', type=int, default=10, help="number of neighbors used to build DGG by FP")
parser.add_argument('--k4', type=int, default=20, help="number of neighbors used to build DGG w/o FP")
parser.add_argument('--use_FP', default=True, help="use our RNFD")
parser.add_argument('--FP_rate', type=float, default=0.25)
parser.add_argument('--use_spectrum', default=True, help="use our MKGB and GAFA")
parser.add_argument('--topo_channels', type=int, default=32)
